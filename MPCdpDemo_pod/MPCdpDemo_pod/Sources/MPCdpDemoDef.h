...
#ifndef MPCdpDemoDef_h
#define MPCdpDemoDef_h

#define SECTION_LABEL(_title)  \
{   \
    UILabel *label = [[UILabel alloc] init];    \
    label.frame = CGRectMake(hMargin, vPadding + index * (height + vMargin), width, 22);   \
    vPadding += 22 + 5; \
